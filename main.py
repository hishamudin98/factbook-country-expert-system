...
def list_country():
    ...
    count = 0
    print "\nThe countries you can search about are: "
    for line in file:
        con = line[3:]
        count += 1
...
def liveSuggestion(countryDetails):
    ...
    print "\nWhat kind of Population Density do you prefer?\n1.High\n2.Low\n"
    b = int(raw_input())
    if(b == 1):
        l.append("high")
    elif(b == 2):
    ...
    if possibleCountry != []:
        ...
        print "\nSuch a rare combination is not available among the top 40 rich countries of the world!"
...
def tourismSuggestion():
    ...
    print "\nWhat type of place do you wanna go?\n1. Historical Place\n2. Hill Station\n3. Desert Safari\n4. Beaches\n"
    ...
    # print l
    # possiblePlaces = []
    print "\nThe top places you can visit are: "
    for item in tourism:
        # print item, '-----'
